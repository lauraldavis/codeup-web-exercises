...
var dailyRateDollars = Number(prompt("Enter the price in dollars for a movie (per day):"));
var littleMermaidDays = Number(prompt("Enter #days rental for The Little Mermaid:"));
var brotherBearDays = Number(prompt("Enter #days rental for Brother Bear:"));
var herculesDays = Number(prompt("Enter #days rental for Hercules:"));
var totalDays = littleMermaidDays + brotherBearDays + herculesDays;
var totalPaymentDue = totalDays * dailyRateDollars;
alert("3a. The total movie rental payment due is: $" + totalPaymentDue);
...
alert("3b. Your total paycheck for this week is: $" + totalWeeklyPayDollars);
...
var isPremiumMember = false, isProductOfferCurrent = true;
var isProductDiscountValid = isProductOfferCurrent && (itemsPurchasedCount > 2 || isPremiumMember);

alert("3d. This product offer validation is: " + isProductDiscountValid);
